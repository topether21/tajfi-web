            ...
            <div className="mb-8">
                <div className="flex justify-between items-center mb-4">
                    <Input
                        ...
                        value={`$${usdAmount}`}
                        readOnly
                        className={`text-4xl font-light bg-transparent border-none text-white p-0 h-auto ${activeInput === "USD" ? "text-white" : "text-gray-500"
                            }`}
                ...
                <div className="flex justify-between items-center">
                    <Input
                        ...
                        value={satAmount}
                        readOnly
                        className={`text-4xl font-light bg-transparent border-none text-white p-0 h-auto ${activeInput === "SAT" ? "text-white" : "text-gray-500"
                            }`}
            ...
            <div className="grid grid-cols-3 gap-y-6 mb-8">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9, ".", 0].map((num) => (
                    <Button
                        ...
                        onClick={() =>
                            num === "." ? handleDecimalClick() : handleNumberClick(num.toString())
                        }
                    >
                        {num}
                    </Button>
