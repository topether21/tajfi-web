...
export const HOME_FEATURED_COLLECTIONS_DESCRIPTION =
  'Discover a curated selection of unique digital artifacts inscribed on individual satoshis with Taproot.'
