  ...
  return (
    <div className="flex flex-col items-center justify-start h-full text-foreground">
      ...
      <div className="w-full max-w-md pt-4">
        <div className="mb-8">
          <label htmlFor="receive-amount" className="block text-base font-medium -mb-4">
            Amount
          </label>
        ...
        <>
          ...
          <div className="w-full flex flex-col items-center max-w-md pb-8">
            <div className="flex justify-around w-full mt-8">
              <Button variant="ghost" className="text-white flex-grow" onClick={copyQRCodeToClipboard}>
