...
export const useSendFunds = () => {
    ...
    const [{ loading: loadingStart, error: errorStart, value: fundedPsbt }, sendFundsStart] = useAsyncFn(async (invoice: string) => {
    ...
    const [{ loading: loadingComplete, error: errorComplete, value: valueComplete }, sendFundsComplete] = useAsyncFn(async (psbt: string) => {
        console.log('sending funds');
        setErrorMessage('');
